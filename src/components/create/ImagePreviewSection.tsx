  ...
  return (
    <section className='pb-16 pt-8'>
      ...
      <div className='mb-6 flex items-center justify-between'>
        <h2 className='text-[20px] font-semibold text-white'>선택된 이미지 미리보기</h2>
            ...
            >
              <div className='relative flex h-[180px] w-full items-center justify-center overflow-hidden rounded-[14px] bg-black/20'>
                {isGenerated ? (
                  ...
                  <div className='flex flex-col items-center gap-2'>
                    ...
                    <span className='text-[10px] text-white/20 uppercase tracking-widest'>No Selected Image</span>
                  </div>
                )}
              </div>
              ...
              <div className='relative px-2 py-4'>
                <p className='text-[14px] leading-relaxed'>
                  ...
                  <span
                    className={cn('transition-colors duration-300', isGenerated ? 'text-white/90' : 'text-white/30')}
                  >
      ...
      {onGoVideo && (
        <div className='mt-10 flex justify-end'>
          <ActionButton
            label={isVideoCreating ? '영상 생성 중...' : '영상 제작하기'}
            disabled={!isButtonEnabled || isVideoCreating}
            onClick={onGoVideo}
          />
        </div>
      )}
