            ...
            <div className='relative flex h-full flex-col'>
              ...
              <div className='flex flex-1 flex-col items-center justify-center text-center'>
                ...
                <button
                    ...
                    className='mt-6 inline-flex h-[42px] items-center justify-center rounded-[12px] bg-[linear-gradient(180deg,rgba(14,89,95,0.96),rgba(9,58,62,0.96))] px-6 text-[13px] font-medium text-cyan-200 shadow-[0_10px_22px_rgba(0,0,0,0.22),inset_0_1px_0_rgba(255,255,255,0.04)] transition hover:opacity-90'
                >
                  전체보기
                </button>
              </div>
