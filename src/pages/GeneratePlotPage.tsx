        ...
        {storyboardItems.map((item) => (
          <div key={item.id} className='flex gap-4'>
            ...
            <div className='relative flex min-h-[96px] flex-1 items-center justify-between overflow-hidden rounded-[18px] bg-[linear-gradient(180deg,rgba(255,255,255,0.038),rgba(255,255,255,0.016))] px-6 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.02),0_14px_34px_rgba(0,0,0,0.24)] backdrop-blur-md'>
              ...
              {item.done ? (
                <button className='relative ml-4 flex h-[48px] w-[92px] items-center justify-center overflow-hidden rounded-[14px] bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.045))] !text-[12px] font-medium text-white/92 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]'>
                ...
                <button className='relative ml-4 flex h-[42px] w-[126px] items-center justify-center overflow-hidden rounded-[14px] bg-[linear-gradient(180deg,rgba(14,89,95,0.96),rgba(9,58,62,0.96))] !text-[12px] font-medium text-white shadow-[0_10px_22px_rgba(0,0,0,0.22),inset_0_1px_0_rgba(255,255,255,0.04)] transition hover:opacity-90'>
